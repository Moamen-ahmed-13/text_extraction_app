...
class FirebaseFirestoreService {
  ...
  Future<void> updateUserProfile({required String userId, String? fullName, String? profileImageUrl}) async {
    try {
...
Future<void> deleteUserProfile(String userId) async {
  ...
  Future<void > saveExtractionToCloud({required String userId, required String imageUrl, required String extractedText})async {
    try {
      await _firestore.collection(AppConstants.extractionHistoryCollection).add({
        'user_id': userId,
        'image_url': imageUrl,
